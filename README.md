...
Hyperparameter Tuning: Implements GridSearchCV to minimize Mean Squared Error (MSE).
...
Automated Audit Pipeline: A custom Python routine that automatically generates and saves performance visualizations to the /plots directory.
...
Optimization Strategy: Negative Mean Squared Error minimization.
